        ...
        <table className="table table-sm table-hover" style={tableStyle}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={borderRight}>{properties.fingerAbility.startValue}</td>
            ...
            <tr>
              ...
              <td style={borderRight}>{properties.constitution.startValue}</td>
            ...
            <tr>
              ...
              <td style={borderRight}>{properties.socialStatus.startValue}</td>
            ...
            <tr>
              ...
              <td style={borderRight}>{properties.initiativBaseValue.value}</td>
              <td />
            </tr>
            <tr>
